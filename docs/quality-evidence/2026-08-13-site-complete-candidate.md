...
| Accessibility     | Automated mobile scan                                                               | FAIL       | `/`, `/basement/`, `/location/hamilton/` | Lighthouse 12.8.2 Accessibility                                           | All three score 94; contrast and heading-order findings remain                                         | Forge / MTC     |
...
| Images            | Reserved dimensions/aspect ratio                                                    | FAIL       | Site-wide                                | Generated HTML audit                                                      | 434 of 608 generated images lack deterministic reserved space; CI budget prevents regression above 434 | Forge           |
...
| --------------------- | ------------------------- | ----------: | ------------: | -------------: | --: | --------: | ------: | ----: | --------------------------------------------- |
| `/`                   | Lighthouse mobile default |          62 |            94 |            100 | 100 | 12,256 ms |   48 ms | 0.001 | Static local server; no CDN compression/cache |
| `/basement/`          | Lighthouse mobile default |          64 |            94 |            100 | 100 |  7,727 ms |   45 ms | 0.001 | Static local server; no CDN compression/cache |
| `/location/hamilton/` | Lighthouse mobile default |          65 |            94 |            100 | 100 |  6,384 ms |   48 ms | 0.033 | Static local server; no CDN compression/cache |
...
- Failed mandatory requirements: 434 images without reserved dimensions; automated color-contrast and heading-order findings; representative mobile Performance and LCP below the house thresholds.
